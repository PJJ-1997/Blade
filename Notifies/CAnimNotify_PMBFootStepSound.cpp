...
#include "Notifies/CAnimNotify_PMBFootStepSound.h"
...
#include "World/Res_PMBFootStepSoundList.h"

UCAnimNotify_PMBFootStepSound::UCAnimNotify_PMBFootStepSound() : Super()
{
...
void UCAnimNotify_PMBFootStepSound::Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	FootStep(MeshComp);
}

void UCAnimNotify_PMBFootStepSound::FootStep(USkeletalMeshComponent* MeshComp)
{
