...
#include "CDownAttack_Sword.generated.h"

UCLASS(Blueprintable)
class U06_BATTLE_API UCDownAttack_Sword : public UCDownAttack
{
	GENERATED_BODY()
private:
...
public:
	virtual void Begin_DownAttack_Implementation() override;
	virtual void End_DownAttack_Implementation() override;
