...
#include "Weapons/SkillActions/CZAction_Sword.h"
#include "Global.h"
...
void UCZAction_Sword::Begin_ZAction_Implementation()
{
	...
	if (Attachment->OnAttachmentBeginOverlap.IsAlreadyBound(this, &UCZAction_Sword::OnAttachmentBeginOverlap))
	{
	...
	if (!Attachment->OnAttachmentBeginOverlap.IsAlreadyBound(this, &UCZAction_Sword::OnAttachmentBeginOverlap))
	{
		Attachment->OnAttachmentBeginOverlap.AddDynamic(this, &UCZAction_Sword::OnAttachmentBeginOverlap);
	}
...
void UCZAction_Sword::End_ZAction_Implementation()
{
	...
	if (!Attachment->OnAttachmentBeginOverlap.IsAlreadyBound(DoAction, &UCDoAction::OnAttachmentBeginOverlap))
	{
		Attachment->OnAttachmentBeginOverlap.AddDynamic(DoAction, &UCDoAction::OnAttachmentBeginOverlap);
	}
...
void UCZAction_Sword::Tick_Implementation(float InDeltaTime)
{
...
void UCZAction_Sword::OnAttachmentBeginOverlap(ACharacter * InAttacker, AActor * InAttackCuaser, ACharacter * InOther)
{
	CheckNull(InOther);
